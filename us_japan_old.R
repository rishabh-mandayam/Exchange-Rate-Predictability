...
e_t_predictions[1] = japan_time_series$e[34]
for (i in 2:40) {
  print(i)
  print(out_z[i-1])
...
e_t_out_of_sample_actual = japan_time_series$e[34:74]
time = japan_time_series$time[34:74]
...
time <- factor(japan_time_series$time[34:74], levels = split_times)
